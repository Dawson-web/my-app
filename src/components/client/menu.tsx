...
export default function Menu(props: any) {
  ...
  return (
    <NavigationMenu className={clsx("shadow-lg ", {})}>
      <NavigationMenuList
        className={clsx("flex h-full justify-start", {
          "sm:flex-row": layout === "vertical",
          "sm:flex-col": layout === "horizontal",
      ...
      >
        <NavigationMenuItem
          className={clsx(
            "h-10 w-[100px]  bg-background px-4 py-2 self-center",
            {
